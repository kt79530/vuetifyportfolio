    ...
    <v-layout>
        ...
        <v-main>
            <v-container>
                <v-row>
                    <v-col>
<h1 class="text-primary">확장 패널 => <small class="text-secondary">부트스트랩에서는 collapse{faq}</small></h1>
                   <v-expansion-panels>
                        <v-expansion-panel
                        title="Title"
                        text="adsflkga;dkglj;alkjsgh"
                        >
                   ...
                   <v-expansion-panels v-model="panel" multiple></v-expansion-panels>
