...
<v-fade-transition hide-on-leave>
    ...
    <div class="py-12 text-center">
        ...
        <v-row align="center" justify="center" >
           <v-col>
            <v-btn block>Rounded Button</v-btn>
           </v-col>
        </v-row> 
    ...
    width="100%"
        ...
        <v-btn prepend-icon="$vuetify" stacked="mx-3" >btn</v-btn>
        </p>
...
<script setup> /* <-- vue3에서 컴포지션 API를 간결하게 사용할 수 있도록 해주는 SFC문법이다*/
import {useLayout} from 'vuetify'

const Child = {
    setup(props, ctx){ //setup함부의 매개변수
        const {getLayoutItem} = useLayout()

        function print(key){ //key값을 받아서 아이템의 정보를 json으로 경고장 출력
